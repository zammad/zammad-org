...
If you want to install Zammad via LLM agent, do so by pointing your agent to one of the installation instruction files
you can find below.

## Installation via Docker Compose

This file covers an installation via Docker Compose by fetching the default
[Docker Compose repository](https://github.com/zammad/zammad-docker-compose){target=_blank} of Zammad.
...
This file covers an installation via package manager, including Elasticsearch.
