...
After activating the search field, you can find the tickets you recently closed from your taskbar and your last
search queries.
...
user), what you are searching.

Have a look at the [search guide](/en/documentation/use/guides/search) for more details.
...
in the notification, this ticket gets opened in the navigation sidebar as a tab and the ticket detail view is displayed.
