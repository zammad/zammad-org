...
[personal settings](/en/documentation/use/user-profile#notifications). Zammad also ships a default overview called
...
of accounted times for all activity types. Accounted time is also shown in the article meta information of each ticket
article, if present.
