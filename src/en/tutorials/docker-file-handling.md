...
Our example uses the tool [filebrowser](https://filebrowser.org/), but any similar tool should work too. If you'd like
to use such a tool permanently, make sure to provide additional volumes for persistence (e.g. for their database).
