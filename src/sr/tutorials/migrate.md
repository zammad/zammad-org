...
протокол у интерфејсу администратора Zammad-а под _Подешавања > Систем > Основно_.
Ово је важно јер се чаробњак за почетак не извршава током
миграције.
...
Ако ваш систем није наведен, имате две опције. Можете или
користити моћан Zammad APIа или послати поруку нашем
[тиму за продају](https://zammad.com/en/company/contact){target=_blank} ради прилагођеног
развоја или чак спонзорисања извора миграције.

Миграције су доступне и за SaaS инстанце! Контактирајте подршку за више
информација!
:::
...
::: warning
Уверите се да користите API кључ налога са потпуним администраторским приступом. Коришћење налога
са нижим дозволама може довести до неуспеле миграције.
:::
...
::: warning
Уверите се да наведете кориснички налог са пуним администраторским дозволама. Корисници
са мање привилегија ће довести до неуспеле миграције.
:::
...
::: tip
У неким случајевима рестартовање вашег веб сервера може помоћи да решите
интерне грешке сервера.
:::
