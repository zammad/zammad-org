...
::: warning
Пре покретања пажљиво проверите команде, јер неке од њих
могу изазвати губитак података или оштећења тикета! Ако нисте сигурни,
**прво пробајте на тест систему**!
:::
...
::: warning
Ово подешавање такође утиче на понашање CSRF токена у Zammad-у. Ако га поставите
нпр. на HTTPs, а користите HTTP, пријављивање корисника неће бити
могуће!

Не утиче на SSL сертификате или било какву конфигурацију веб сервера.
:::

Проверите тренутну врсту HTTP протокола:
...
### Подразумевана врста тикета на отварању
...
### Приказује напомену приликом додавања чланка
...
#### Нови чланак у постојећим тикетима
...
### Укључује преглед прилога у бочној траци тикета
...
::: warning
Клијенти **не могу** бити обрисани док имају преостале тикете у
систему.

Услед тога, примери испод бришу не само одабране
клијенте, него и **све тикете повезане са њима**. Команде
испод бришу без додатних упозорења.
:::
