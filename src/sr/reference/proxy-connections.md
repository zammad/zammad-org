...
|                                           | UI подешавање | Променљива окружења  |
|-------------------------------------------|---------------|----------------------|
| Захтева приступ оперативном систему хоста | не            | да                   |
| Аутоматски искључује интерне адресе       | да            | не                   |
| Извршава проверу конфигурације            | да            | ручно, преко скрипте |
| Грешке                                    | да            | не                   |
...
::: tip
У зависности од окружења, можда ћете желети да користите и варијанте променљивих малим словима. Ако нисте сигурни, поставите
обе варијанте наводећи им вредности оних великим словима, на пример:
...
| Адреса             | Напомена                                    |
|--------------------|---------------------------------------------|
| dl.packager.io     | Преузимање OS пакета (инсталација пакета)   |
| go.packager.io     | Исто као изнад; нов сервис хостовања пакета |
| geo.zammad.com     | Користи се за геолокацију                   |
| google.com         | Преузимање празника за календар             |
| index.rubygems.org | Преузимање Ruby gem модула                  |
| registry.npmjs.org | Преузимање JS библиотека                    |
