...
: An API (Application Programming Interface) is a connection that allows you
  ...
  [API landing page](https://zammad.com/en/product/features/rest-api).
...
: Autosave might be one of the coolest traits of Zammad:
  ...
  You can learn more on our
  [Autosave landing page](https://zammad.com/en/product/features/autosave).
...
: With every new release comes a new changelog. It is basically a list of all
  ...
  You can find them all on our [GitHub](https://github.com/zammad/zammad/blob/stable/CHANGELOG.md)!
...
Core Workflows
: This feature allows every organization to configure their individual
  dynamic fields and ticket masks based on their specific workflows.
...
: Zammad offers an Elasticsearch integration (a free and open search engine)
  that makes the search process within Zammad super fast and powerful.

  ::: info <Badge type="info" text="Cloud Service only" />
  ...
  as well it is out of our documentation scope.
  :::
...
: Users can let us know if they are missing a particular feature in Zammad.
  ...
  in our Community in the Feature Request category.
...
: GitHub is a service for the version management of software development
  ...
  You can find the repository [here](https://github.com/zammad/zammad).
...
: Every few months, we bring a new version of Zammad into the world,
  ...
  In our [release notes](https://zammad.com/en/releases) you can find what is
  included in new versions and also important Information about what you should
  consider before updating Zammad.
