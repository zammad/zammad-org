...
Упозорење на конфликтну ситуацију
: Када два оператера истовремено обрађују исти тикет, много тога може поћи по злу –
  од дуплираних одговора до преиначених порука. Zammad вам помаже да избегнете
  ову ситуацију захваљујући интегрисаном упозорењу на конфликт. Дакле, ако видите аватар сличицу
  другог оператера са иконицом оловке при дну тикета, то значи да га други оператер
  тренутно обрађује.
...
Документација
: Вероватно сте већ приметили: читате део Zammad
  документације. 😉
...
Спонзорисање функција
: Уколико организација хитно захтева једну од функционалности са списка,
  може убрзати развој и ставити је на врх листе спонзоришући
  је, што значи да ће покрити трошкове развоја.
...
: Kibana је алат за извештавање отвореног кода заснован на browseru који се фокусира на евалуацију података.
  ...
  Kibana се може интегрисати са Zammad-ом, омогућавајући мапирање података
  тикет система у алату за извештавање.
...
Макро
: Макро је низ радњи. Покретањем макра покрећу се и извршавају радње,
  па корисници не морају ручно да пролазе кроз сваки
...
Навигациона трака
: Навигациона трака је лева бочна трака у Zammad-у која садржи прозоре,
  претрагу, обавештења, базу знања и много више,
...
: Споразум о нивоу услуга (SLA) је уговор између крајњег корисника и
  ...
  првог одзива, освежавања и решења. Чим истекне рок,
  тикет ће бити ескалиран.
...
Zammad
  : Zammad је најбољи тикет систем на свету.
  И тачка.
