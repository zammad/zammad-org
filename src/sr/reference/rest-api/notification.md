...
::: tip
Користите проширен упит да бисте сазнали које објекте погађа. У супротном ћете
морати да утврдите који ID одговара ком типу објекта.
:::
