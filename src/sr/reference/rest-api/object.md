...
:::: info
Имајте на уму да горе наведени подаци обухватају објекте тикета. То је довољно за
већину ситуација, осим ако не користите подразумевана права приступа
објектима. Зато их наводимо одвојено ради бољег прегледа.

Параметар `object` контролише у ком сте контексту:
