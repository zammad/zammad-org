...
- Обе функције су опционе. Уколико не видите дугмиће `Шифровање` и
  `Потписивање` изнад уређивача имејл чланка, то значи да их ваш
  администратор још није укључио.
...
потписивања одлазних имејл порука. Доступни су на новим тикетима и на
...
Можда ћете видети дугмиће `PGP` и `S/MIME`. Ово се дешава када су оба
...
безбедности. Само изаберите један, проверите да су шифровање и потписивање
укључени и пошаљите своју поруку.
