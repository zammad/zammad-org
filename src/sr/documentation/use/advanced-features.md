...
Укључите прекидач **Претплати се** у бочној траци тикета за добијање
...
![Снимак екрана приказује бочни панел спајања
...
Идите на тикет који желите да спојите са другим. Из бочне траке тикета,
одаберите `Споји` у падајућем менију ::a::. Ово ће отворити бочни панел у
коме можете одабрати тикет кликом на исти или уносом броја тикета у поље за
...
У бочној траци тикета, додајте везу на други тикет кликом на дугме ::+:: у
одељку **Повезани тикети**.  Ово ће отворити бочни панел са стране у ком
можете одабрати тикет кликом на исти или уносом броја тикета у поље за
претрагу.  Додатно, можете изабрати између различитих врста веза:
...
- Види историјат измена (преко менија ::a::)
- Направите нови тикет са овим корисником као клијентом

**Како?**

Само кликните на аватар корисника (нпр. у заглављу детаљног приказа
тикета). Ово отвара нови прозор са детаљним приказом клијента. Ако имате и
администраторска овлашћења, преко менија ::a:: можете чак додати и задатак
за брисање корисника.

## Детаљни приказ организације

![Снимак екрана приказује детаљни приказ
...
Омогућава вам да колегама укажете на важне аспекте тикета и осигурате да се
...
![Снимак екрана приказује мени за истицање у детаљном приказу
тикета](/screenshots/cypress/documentation/use/advanced-features.cy.js/text-highlighting.png)

Користите алат за истицање са иконицом оловке у горњем десном углу детаљног
приказа тикета. Да бисте истакли текст, прво изаберите текст а затим
кликните дугме. Као алтернативу, можете прво кликнути дугме за истицање, па
изабрати текст. Различиту боју можете изабрати помоћу стрелице надоле са
десној стране дугмета. Да бисте уклонили истицање, једноставно изаберите
иконицу гумице из менија за боје.
