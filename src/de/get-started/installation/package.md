...
If you are still using MySQL/MariaDB, you should [migrate to
PostgreSQL](/en/tutorials/migrate-database). MySQL/MariaDB are **no longer**
supported starting with Zammad 7.
