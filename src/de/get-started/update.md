...
::: info
Diese Seite beinhaltet ausschließlich die Aktualisierung von Zammad. Wenn Sie Ihr Host-Betriebssystem ebenfalls aktualisieren möchten,
...
oder Breaking Changes beinhalten. Prüfen Sie immer zuerst die [Docker Compose Release-Notes](https://github.com/zammad/zammad-docker-compose/releases){target=_blank}
...
`VERSION` ([Beispiel](https://github.com/zammad/zammad-docker-compose/blob/master/.env.dist){target=_blank} mit weiteren Details)
...
### Docker Compose-basierte Installation aktualisieren
