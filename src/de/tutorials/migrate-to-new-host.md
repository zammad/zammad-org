...
before migrating. Have a look at the installation instructions and follow
the steps.
...
This makes sure that no data is lost during the process. Go to Zammad's
admin interface and disable all active communication channels.
