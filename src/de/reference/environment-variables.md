...
| REDIS_URL                                              |              | - Docker: `redis://zammad-redis:6379`<br> - Paket: nicht gesetzt   | Legen Sie Ihre eigene Redis-Instanz fest, sofern Sie eine haben. Der Fallback bei Paket-Installationen ist `/opt/zammad/tmp/websocket_*`. Siehe [Redis-Variablen](/de/reference/redis) für eine Sentinel-Einrichtung.                                                                                                                                                                                                                                                                                                                                                                                                                  |
